$(document).ready(function () {
    ...
    if (currentPath.includes('manual_dilution')) {
        ...
        $("#addSampleVolume").on("click",function (event) {
            ...
            if (pipetteid.val() === "") {
                pipetteid.addClass('is-invalid');
                status = false;
            } else {
                pipetteid.removeClass('is-invalid');
            }
        ...
        $('form#manual_dilution').on('submit', function (event) {
            ...
            if (pipetteid.val() === "") {
                ...
                pipetteid.removeClass('is-invalid');
                formData.append('pipetteid', pipetteid.val());
            }
